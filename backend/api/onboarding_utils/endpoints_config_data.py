...
async def generate_website_preview(intake: Dict[str, Any], current_user: Dict[str, Any]):
    try:
        ...
        from services.website_automation_service import website_automation_service
        ...
        preview = website_automation_service.generate_preview_site(user_id, site_brief, css)
