/**
 * Billing Types
 * Type definitions and validation schemas for billing services
 */
...
export interface TrendsAPIResponse extends BillingAPIResponse<UsageTrends> {}
...
export const ProviderBreakdownSchema = z.object({
  gemini: ProviderUsageSchema.optional(),
  huggingface: ProviderUsageSchema.optional(),
  video: ProviderUsageSchema.optional(),
  audio: ProviderUsageSchema.optional(),
  image: ProviderUsageSchema.optional(),
  image_edit: ProviderUsageSchema.optional(),
  tavily: ProviderUsageSchema.optional(),
  serper: ProviderUsageSchema.optional(),
  exa: ProviderUsageSchema.optional(),
});
